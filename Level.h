...
class Level
{
    public:
        ...
        bool LoadFromFile(std::string filename,  b2World &world);
        ...
        //Returns a vector of different objects inside of a vector of all objects

        std::vector <std::vector< Object > > getAllObjects();
